...
<section class="content-header">
    ...
    <li class="active"> <?php T::__("Users List"); ?></li>
    </ol>
</section>
<section class="content">
    ...
    <?php echo MessageHelper::getMessageHTML(); ?>
        ...
        <div class="box-header">
            <h3 class="box-title"><?php T::__("Users List Table"); ?></h3>
            ...
            <button type="button" data-toggle="openModal" data-target="#addUserModal" href="index.php?controller=forms&action=add" class="btn btn-success pull-right">
        ...
        <div class="box-body table-responsive no-padding">
            ...
            <tr data-id="<?php echo $user->pkUserID; ?>">
                <td><a data-toggle="tooltip" title="Düzenle" class="text-red" href="index.php?controller=module&action=users&do=edit&id=<?php echo $user->pkUserID; ?>"><i class="fa fa-edit"></i></a></td>
                <td class="has-link"><?php echo $user->fullname; ?></td>
                <td class="has-link"><?php echo $user->username; ?></td>
                <td class="has-link"><?php echo "" ?></td>
                <td class="has-link"><?php echo $user->email; ?></td>
                <td class="has-link"><?php echo $user->lastVisit; ?></td>
                <td class="has-link"><?php echo $user->registrationDate; ?></td>
                <td class="has-link"><?php echo $user->pkUserID; ?></td>
            </tr>
            <?php endforeach; ?>
            </tbody></table>
        </div>
...
<?php ViewHelper::getView('users','addUser');?>
