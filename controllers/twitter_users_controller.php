...
class TwitterUsersController implements ModuleInterface
{
    public static function getList($params=array()) {
        ...
        $objList = TwitterUsers::getObjList($params);

        $pagination = (new Pagination());
        $pagination->setCurrent($page);
        $pagination->setRPP($limit);
        $pagination->setTotal(TwitterUsers::getTotal($search_term));
        $pagination->setClasses(array("pagination","pagination-sm","no-margin","pull-right"));
        $paginationHTML = $pagination->parse();
        
        ViewHelper::setTitle('Minyy | Twitter Users');
        ViewHelper::getView('twitter_users','twitter_users');
    }
    public static function add() {
        ...
        global $randomUser;
        $randomUser = TwitterHelper::getRandomUserId();
        
        ViewHelper::setTitle('Minyy | Twitter Users Add');
        ViewHelper::getView('twitter_users','add_twitter_user');
    }
